...
namespace KA.DataProvider.Migrations
{
    ...
    [Migration("20230212143726_dbv15")]
    partial class dbv15
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KA.DataProvider.Entities.Contact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KA.DataProvider.Entities.Course", b =>
                {
                    ...
                    b.Property<bool>("IsUseExternalHtml")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("KA.DataProvider.Entities.OfflineCourseRegister", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("offlinecourseregisters");
                });

            modelBuilder.Entity("KA.DataProvider.Entities.OfflineCourseStartDate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<int>("OfflineCourseId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("offlinecoursestartdates");
                });
            ...
            modelBuilder.Entity("KA.DataProvider.Entities.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KA.DataProvider.Entities.OrderDetail", b =>
                {
                    ...
                    b.HasOne("KA.DataProvider.Entities.Order", "Order")
                        .WithMany("OrderDetails")
